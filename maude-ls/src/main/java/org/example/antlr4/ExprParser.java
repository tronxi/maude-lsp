...
public class ExprParser extends Parser {
	...
	@SuppressWarnings("CheckReturnValue")
	public static class ComboContext extends ExprContext {
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		public ComboContext(ExprContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ExprListener ) ((ExprListener)listener).enterCombo(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ExprListener ) ((ExprListener)listener).exitCombo(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case T__4:
				{
				_localctx = new ComboContext(_localctx);
				_ctx = _localctx;
				_prevctx = _localctx;
				setState(9);
				match(T__4);
